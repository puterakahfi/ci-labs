...
class reports extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Gallery.Reports.View');
	...
	{
		$this->auth->restrict('Gallery.Reports.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_gallery())
			{
				...
				redirect(SITE_AREA .'/reports/gallery');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Gallery.Reports.Edit');
		...
		{
			$this->auth->restrict('Gallery.Reports.Delete');
