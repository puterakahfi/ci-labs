...
class developer extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Gallery.Developer.View');
	...
	{
		$this->auth->restrict('Gallery.Developer.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_gallery())
			{
				...
				redirect(SITE_AREA .'/developer/gallery');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Gallery.Developer.Edit');
		...
		{
			$this->auth->restrict('Gallery.Developer.Delete');
