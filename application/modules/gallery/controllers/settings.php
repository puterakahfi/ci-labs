...
class settings extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Gallery.Settings.View');
	...
	{
		$this->auth->restrict('Gallery.Settings.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_gallery())
			{
				...
				redirect(SITE_AREA .'/settings/gallery');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Gallery.Settings.Edit');
		...
		{
			$this->auth->restrict('Gallery.Settings.Delete');
