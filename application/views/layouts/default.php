...
<head>
    <meta charset="UTF-8">
    <title>cilabs indonesia | Dashboard</title>
    ...
    <!-- Ionicons -->
    <link href="<?php echo base_url('assets/lte/css/ionicons.min.css');?>" rel="stylesheet" type="text/css" />
    <!-- Morris chart -->
    ...
    <!-- Theme style -->
    <link href="<?php echo base_url('assets/lte/css/AdminLTE.cs');?>s" rel="stylesheet" type="text/css" />
    ...
    <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
      ...
      <body class="skin-blue">
            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="<?php echo site_url('page/lte');?>">
                                <i class="fa fa-dashboard"></i> <span>LTE ADMIN PAGE</span>
                            </a>
                        </li>
                    </ul>
                </section>
        ...
        <!-- jQuery 2.0.2 -->
        <script src="<?php echo base_url('assets/lte/js/jquery.min.js');?>"></script>
        <!-- jQuery UI 1.10.3 -->
        <script src="<?php echo base_url('assets/lte/js/jquery-ui-1.10.3.min.js');?>" type="text/javascript"></script>
        <!-- Bootstrap -->
        <script src="<?php echo base_url('assets/lte/js/bootstrap.min.js');?>" type="text/javascript"></script>
        <!-- Morris.js charts -->
